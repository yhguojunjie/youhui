package com.yoxi.hudongtui.model.cj.receipt;

import java.util.Date;

public class ActReceiptConf implements java.io.Serializable{
	...
	public String getbInputPass() {
		return bInputPass;
	}

	public void setbInputPass(String bInputPass) {
		this.bInputPass = bInputPass;
	}
