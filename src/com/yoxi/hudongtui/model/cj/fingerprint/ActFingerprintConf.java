package com.yoxi.hudongtui.model.cj.fingerprint;

import java.util.Date;

public class ActFingerprintConf implements java.io.Serializable{
	...
	public String getbCanPlay() {
		return bCanPlay;
	}

	public void setbCanPlay(String bCanPlay) {
	...
	public String getPrizeRelation() {
		return prizeRelation;
	}

	public void setPrizeRelation(String prizeRelation) {
		this.prizeRelation = prizeRelation;
	}
