...
public class ActRunmanConf implements java.io.Serializable{
	...
	public String getAfterShareUrl() {
		return afterShareUrl;
	}

	public void setAfterShareUrl(String afterShareUrl) {
		this.afterShareUrl = afterShareUrl;
	}
