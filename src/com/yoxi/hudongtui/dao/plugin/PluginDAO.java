...
public interface PluginDAO {
	 ...
	 */
	@SQL("SELECT count(*) FROM t_plugin a ##(:condition)")
	public int getPluginCount(@SQLParam("condition") String condition) throws Exception;
	...
	public List<PluginDetailVO> findPlugins(@SQLParam("condition") String condition, int startRow, int pageSize) throws Exception;
	...
	public List<PluginDetailVO> findTjPlugines(@SQLParam("tjCondition") String tjCondition) throws Exception ;
	...
	public List<PluginDetailVO> findPluginesByCondition(@SQLParam("condition") String condition) throws Exception ;
	...
	public List<PluginDetailVO> finDevUserPlugins(@SQLParam("condition") String condition, int count) throws Exception;
	...
	public List<PluginDetailVO> finDevUserPlugin4Page(@SQLParam("condition") String condition, int startRow, int pageSize) throws Exception;
	...
	public List<PluginDetailVO> getAgentPluginList(Integer agentId,@SQLParam("condition") String condition,int start,int count)throws Exception;
}
