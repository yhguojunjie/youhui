...
public class WxPayHelper {
	...
	public WxPayHelper() {
		AppId = WxPayConstants.getAPPID();
		AppKey = WxPayConstants.getPAYSIGNKEY();
		PartnerKey = WxPayConstants.getPARTNERKEY();
	...
	public String GetCftPackage() throws SDKRuntimeException {
		...
		String unSignParaString = WxPayCommonUtil.FormatBizQueryParaMap(parameters,
				false);
		String paraString = WxPayCommonUtil.FormatBizQueryParaMap(parameters, true);
	...
	public String GetBizSign(HashMap<String, String> bizObj)
		...
		String bizString = WxPayCommonUtil.FormatBizQueryParaMap(bizParameters,
				false);
//		System.out.println("***********bizString**************="+bizString);
	 ...
	 * @throws SDKRuntimeException
	 */
	public String GetQueryStringStyle(HashMap<String, String> bizObj)
			throws SDKRuntimeException {
		HashMap<String, String> bizParameters = new HashMap<String, String>();
...
//		bizParameters.put("appkey", AppKey);
		String bizString = WxPayCommonUtil.FormatBizQueryParaMap(bizParameters,
				false);
		System.out.println("***********QueryStringStyle**************="+bizString);
	...
	public String CreateAppPackage(String traceid) throws SDKRuntimeException {
		...
		nativeObj.put("noncestr", WxPayCommonUtil.CreateNoncestr());
	...
	public String CreateNativeUrl(String productid) throws SDKRuntimeException {
		...
		try {
			...
			bizString = WxPayCommonUtil.FormatBizQueryParaMap(nativeObj, false);
	...
	public String CreateNativePackage(String retcode, String reterrmsg) throws SDKRuntimeException {
		...
		return WxPayCommonUtil.ArrayToXml(nativeObj);

	}
	
	/**
	 * 生成发货通知app_signature字段
	 * @param deliverNotifyRes
	 * @return
	 * @throws SDKRuntimeException
	 */
	public String CreateDeliverNotifyAppSign(DeliverNotifyReq deliverNotifyRes)throws SDKRuntimeException{
		HashMap<String, String> nativeObj = new HashMap<String, String>();
		
		nativeObj.put("appid", deliverNotifyRes.getAppid());
		nativeObj.put("appkey",AppKey);
		nativeObj.put("openid", deliverNotifyRes.getOpenid());
		nativeObj.put("transid",deliverNotifyRes.getTransid());
		nativeObj.put("out_trade_no", deliverNotifyRes.getOut_trade_no());
		nativeObj.put("deliver_timestamp", deliverNotifyRes.getDeliver_timestamp());
		nativeObj.put("deliver_status", deliverNotifyRes.getDeliver_status());
		nativeObj.put("deliver_msg", deliverNotifyRes.getDeliver_msg());
		return GetBizSign(nativeObj);
	}
}
