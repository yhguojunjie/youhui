...
function getRootPath(){
    ...
    var curWwwPath=window.location.protocol+"//"+window.location.host;//window.document.location.href;
    ...
    var projectName=window.location.pathname.split('/')[1];//pathName.substring(0,pathName.substr(1).indexOf('/')+1);
