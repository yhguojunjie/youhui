...
<body>
	...
	<div class="w1190 coupon">
		...
		<div class="fl w840 main">
			...
			<div class="cont">
				<form action="${path}/pluginadmin/coupon/add_do" method="post" onsubmit="return onClick();">
					...
					<div class="basic_config">
						<div class="row">
							...
							<div class="fr">
								<p>
									<input name="name" class="verify_name w300" type="text" maxlength="30" value="分享送礼券" />
								</p>
							</div>
							<div class="clear"></div>
						</div>
						<div class="row">
							...
							<div class="fr">
								<div class="preview"><img class="w80 h80" src="${adminImgPath}/coupon/logo.jpg" /></div>
						...
						<div class="row">
							...
							<div class="fr">
								<p>
									<input name="shareTitle" class="verify_title w300" type="text" maxlength="25" placeholder="标题" value="一人分享，俩人得礼" />
									<b>发送给朋友、分享朋友圈，均会显示标题</b>
								</p>
								<div class="space_10"><!-- 填充10像素间距 --></div>
								<p>
									<textarea name="shareDescription" class="verify_intro w300" maxlength="36" placeholder="简介">你分享，我领取；传幸福，均得礼。</textarea>
								...
								<div class="control-group">
									<div class="controls">
										<div class="input-append">
											<input type="text" name="activityTime" class="verify_time daterangepick input-xlarge w320" value="" readonly="readonly" />
											<b>请勿超过模版有效期限</b>
										</div>
									</div>
								</div>
...
<!-- 							<div class="row">
								...
								<div class="fr">
									<p>
										<input name="couponName" class="verify_prizename w300" type="text" maxlength="50" value="50元红包" />
									</p>
								</div>
								<div class="clear"></div>
							</div> -->
							<div class="row">
								...
								<div class="fr">
									<div class="preview"><img class="w200 h100" src="${adminImgPath}/coupon/gift.png" /></div>
									<div class="upload_file">
										<input type="text" class="fileuploadclass" name="couponImgUrl"/>
							...
							<div class="row">
								...
								<div class="fr">
									<p>
										<input name="getAwardUrl" class="verify_contact1 w420" type="text" value="http://mp.weixin.qq.com/s?__biz=MzA3OTU4MDY3OQ==&mid=205448369&idx=1&sn=6e37bed20be43abb2f269a5dc669df2c#rd" />
									</p>
		 						</div>
	 							<div class="clear"></div>
							</div>
					...
					<div class="act_config">
						...
						<div class="row">
							...
							<div class="fr w560">
								<p>
									<textarea name="rule" class="verify_rule w430 h120">分享页面给好友，好友打开页面获得优惠券，同时自己也可获得优惠券。</textarea>
								</p>
							</div>
							<div class="clear"></div>
						</div>
					...
					<div class="custom_config">
						<div class="row">
							...
							<div class="fr w560">
								<div class="preview"><img class="w160 h240" src="${adminImgPath}/coupon/bg.jpg"></div>
								<div class="upload_file">
