	...
	<div class="w1190 ripbrand">
		...
		<div class="fl w840 main">
			<div class="tab_title">
				...
				<a href="${path}/pluginadmin/ripbrand/record/${conf.activityId}">中奖名单</a>
			</div>
			<div class="cont">
				<form action="${path}/pluginadmin/ripbrand/edit_do" method="post" onsubmit="return onClick();">
						...
						<div class="row">
							...
							<div class="fr">
								<div class="preview">
									...
									<c:otherwise>
										<img class="w80 h80" src="${adminImgPath}/ripbrand/logo.jpg" />
									</c:otherwise>
									</c:choose>
								</div>
							...
							<div class="fr w560">
								<div class="preview">
									<c:choose>
										...
										<c:otherwise>  
											<img class="w160 h240" src="${adminImgPath}/ripbrand/bg.jpg" />
										</c:otherwise>
									</c:choose>
								</div>
								<div class="upload_file">
