...
<link type="text/css" rel="stylesheet" href="${adminCssPath}/ripbrand.css"/>
...
<script type="text/javascript" src="${adminJsPath}/ripbrand.js"></script>
...
<body>
	...
	<div class="w1190 ripbrand">
		...
		<div class="fl w840 main">
			...
			<div class="cont">
				<form action="${path}/pluginadmin/ripbrand/add_do" method="post" onsubmit="return onClick();">
					...
					<div class="basic_config">
						<div class="row">
							...
							<div class="fr">
								<p>
									<input name="name" class="verify_name w300" type="text" maxlength="30" value="撕名牌" />
								</p>
							</div>
							<div class="clear"></div>
						</div>
						<div class="row">
							...
							<div class="fr">
								<div class="preview"><img class="w80 h80" src="${adminImgPath}/ripbrand/logo.jpg" /></div>
						...
						<div class="row">
							...
							<div class="fr">
								<p>
									<input name="shareTitle" class="verify_title w300" type="text" maxlength="200" value="天天撕名牌，好礼不断乐开怀！" />
									<b>发送给朋友、分享朋友圈，均会显示标题</b>
								</p>
								<div class="space_10"><!-- 填充10像素间距 --></div>
								<p>
									<textarea name="shareDescription" class="verify_intro w300" maxlength="36" placeholder="简介">明星排排站，轻松撕名牌，惊喜想不到，名牌撕不完。</textarea>
					...
					<div class="cont_config">
						...
						<div class="screen" data-id="1">
							...
							<div class="row">
								...
								<div class="fr">
									<p>
										<input class="verify_prizename w300" type="text" maxlength="50" value="巴厘岛七日游" />
									</p>
								</div>
								<div class="clear"></div>
							</div>
						...
						<div class="screen" data-id="2">
							...
							<div class="row">
								...
								<div class="fr">
									<p>
										<input class="verify_prizename w300" type="text" maxlength="50" value="苹果手表" />
									</p>
								</div>
								<div class="clear"></div>
							</div>
							<div class="row">
								...
								<div class="fr">
									<p>
										<input class="verify_num w80" type="text" value="5" />
										<b>奖品发完后，不会再有用户得奖</b>
									</p>
								</div>
								<div class="clear"></div>
							...
							<div class="space_10"></div>
								...
								<div class="fr w560">
									<p>
										...
										<b>用户打开好友发送或分享至朋友圈的链接，欲参与活动会先跳转该链接。建议用公众号新增图文素材，内容为活动规则，重点引导用户关注，再在公众号内设置关键词回复，如用户发送“撕名牌”，公众号将回复活动链接地址（在PC端我的活动列表获取，该状态下仅在被分享出去的页面生效，原活动链接地址打开的页面不生效)。</b>
									</p>
								</div>
							<div class="clear"></div>
						</div>
						<div id="play_time" class="row">
							<strong class="fl w270">每人每天最多游戏次数：</strong>
							<div class="fr w510">
								<p>
									<input name="playTimes" class="act_count verify_num w80" type="text" value="7" />
									<b>大于1，小于等于7，撕第二张名牌时强制要求分享</b>
								</p>
							</div>
							<div class="clear"></div>
						</div>
						<div class="row">
							...
							<div class="fr w510" style="width:500px;">
								<p>
									...
									<label><input class="cant_join" type="radio" name="bCanPlay" checked="checked" value="1"/>否</label>
								</p>
							</div>
							<div class="clear"></div>
						</div>
...
（模版演示，纯属体验，不予兑奖！)</textarea>
					...
					<div class="custom_config">
						<div class="row">
							...
							<div class="fr w560">
								<div class="preview"><img class="w160 h240" src="${adminImgPath}/ripbrand/bg.jpg"></div>
								<div class="upload_file">
...
<script type="text/javascript">
	...
	function verify_submit(){
		...
		if(verify > 0){
			$('.ripbrand .main .cont .cont_config,.ripbrand .main .cont .act_config,.ripbrand .main .cont .custom_config').attr("style","display:block;");
			$('.ripbrand .main .cont h3 span').text("收起");
			alert("请核查全部字段是否正确填写");
			return false;
		}else{
			return true;
