	...
	<div class="w1190 guessgame">
		...
		<div class="fl w840 main">
			<div class="tab_title">
				...
				<a href="${path}/pluginadmin/guessgame/gameadmin/0?upid=${userPluginId}">比赛管理</a>
				<a href="${path}/pluginadmin/guessgame/betrecord/0?upid=${userPluginId}">投注记录</a>
				<a href="${path}/pluginadmin/guessgame/record/0?upid=${userPluginId}">中奖名单</a>
			</div>
			<div class="cont">
				<form action="${path}/pluginadmin/guessgame/add_do" method="post" onsubmit="return onClick();">
					...
					<div class="basic_config">
						<div class="row">
							...
							<div class="fr">
								<p>
									<input name="name" class="verify_name w300" type="text" maxlength="30" value="猜比赛" />
								</p>
							</div>
							<div class="clear"></div>
						</div>
						<div class="row">
							...
							<div class="fr">
								<div class="preview"><img class="w80 h80" src="${adminImgPath}/guessgame/logo.png" /></div>
						...
						<div class="row">
							...
							<div class="fr">
								...
								<div class="ad_upcont space_10">
									<div class="preview"><img class="w320" src="${adminImgPath}/ad.png" /></div>
									<div class="upload_file">
									...
									<p>
										<input name="advertUrl" class="verify_url w420" type="text" placeholder="链接地址"  value="http://mp.weixin.qq.com/s?__biz=MzA3OTU4MDY3OQ==&mid=204142510&idx=1&sn=d6f2450ecf33baebf8f44f9d72ece296#rd"/>
									</p>
								</div>
							</div>
							<div class="clear"></div>
						...
						<div class="row">
							...
							<div class="fr">
								<p>
									<input name="shareTitle" class="verify_title w300" type="text" maxlength="25" placeholder="标题" value="猜比赛，你说赢，我看行！" />
									<b>发送给朋友、分享朋友圈，均会显示标题</b>
								</p>
								<div class="space_10"><!-- 填充10像素间距 --></div>
								<p>
									<textarea name="shareDescription" class="verify_intro w300" maxlength="36" placeholder="简介">网罗赛事，猜比分，论输赢，给你喜欢的队伍加油！</textarea>
								...
								<div class="control-group">
									<div class="controls">
										<div class="input-append">
											<input type="text" name="activityTime" class="daterangepick input-xlarge w320 verify_time" value="" readonly="readonly"/>
											<b>请勿超过模版有效期限</b>
										</div>
									</div>
								</div>
						...
						<div class="row">
							...
							<div class="fr w560">
								<p>
									...
									<label><input type="radio" name="bJoinType" value="1" <c:if test="${conf.bJoinType == null || conf.bUrlType == '1'}">checked</c:if>/>猜比分</label>
								</p>
							</div>
							<div class="clear"></div>
						</div>
...
(模版演示，纯属体验，不予兑奖！)</textarea>
					...
					<div class="custom_config">
						<div class="row">
							...
							<div class="fr w560">
								<div class="preview"><img class="w160 h240" src="${adminImgPath}/guessgame/bg.jpg"></div>
								<div class="upload_file">
