	...
	<div class="w1190 zanrenqi">
		...
		<div class="fl w840 main">
			<div class="tab_title">
				...
				<a href="${path}/pluginadmin/zanrenqi/record/${conf.activityId}">中奖名单</a>
			</div>
			<div class="cont">
				<form action="${path}/pluginadmin/zanrenqi/edit_do" method="post" onsubmit="return onClick();">
					...
					<div class="basic_config">
						<div class="row">
							...
							<div class="fr">
								<p>
									<input class="w300 verify_title" type="text" maxlength="30" name="name" value="${conf.name}" />
								</p>
							</div>
							<div class="clear"></div>
						</div>
							...
							<div class="fr">
								<div class="preview">
									<c:choose>
										...
										<c:otherwise>
											<img class="w80 h80" src="${adminImgPath}/zanrenqi/logo.png"/>
										</c:otherwise>
									</c:choose>
								</div>
							...
							<div class="fr">
								...
								<div class="ad_upcont space_10">
									<div class="preview">
										...
										<c:otherwise>  
											<img class="w320 imghead" src="${adminImgPath}/ad.gif" />
										</c:otherwise>
										</c:choose>
									</div>
									<div class="upload_file">
						...
						<div class="row">
							...
							<div class="fr">
								<p>
									<input class="w300 verify_shareTitle" type="text" value="${conf.shareTitle}" placeholder="标题" name="shareTitle" maxlength="30" />
									<b>发送给朋友、分享朋友圈，均会显示标题</b>
								</p>
								<div class="space_10"><!-- 填充10像素间距 --></div>
								<p>
									<textarea class="w300 verify_shareDescription" maxlength="36" placeholder="简介" name="shareDescription">${conf.shareDescription}</textarea>
					...
					<div class="cont_config">
						...
						<div class="screen" data-id="${s.count}">
							<h4 class="screen_title"><strong>${s.count}等奖</strong></h4>
							<div class="row">
							...
							<div class="row">
								...
								<div class="fr">
									<p>
										<input class="verify_num w80" type="text" value="${list.getNum}" />
										<b><c:if test="${s.count > 1}">大于前一个奖项集赞数量</c:if></b>
									</p>
								</div>
								<div class="clear"></div>
							</div>
							<div class="row">
								...
								<div class="fr">
									<textarea class="w300 verify_intro" placeholder="描述文案">${list.desc}</textarea>
								</div>
								<div class="clear"></div>
							</div>
							<div class="row">
								...
								<div class="fr">
									<div class="preview">
										...
										<c:when test="${s.count == 1}">
											<img class="w80 h80 imghead" src="${adminImgPath}/zanrenqi/voucher.gif" />
										</c:when>
										<c:when test="${s.count == 2}">
											<img class="w80 h80 imghead" src="${adminImgPath}/zanrenqi/ragdoll.gif" />
										</c:when>
										<c:when test="${s.count == 3}">
											<img class="w80 h80 imghead" src="${adminImgPath}/zanrenqi/toothbrush.gif" />
										</c:when>
										<c:when test="${s.count == 4}">
											<img class="w80 h80 imghead" src="${adminImgPath}/zanrenqi/combag.gif" />
										</c:when>
										</c:choose>
									</div>
									<div class="upload_file">
						...
						<div class="row">
							...
							<div class="fr w560">
								<p>
									...
									<label class="need_usermsg"><input value="name," type="checkbox" checked="checked" <c:if test="${conf.userinfo.contains('name')}">checked</c:if>/>姓名</label>
