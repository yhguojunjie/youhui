	...
	<div class="w1190 fingerprint">
		...
		<div class="fl w840 main">
			<div class="tab_title">
				...
				<a href="${path}/pluginadmin/fingerprint/record/${conf.activityId}">中奖名单</a>
			</div>
			<div class="cont">
				<form action="${path}/pluginadmin/fingerprint/edit_do" method="post" onsubmit="return onClick();">
							...
							<div class="fr">
								<div class="preview">
									<c:choose>
										...
										<c:otherwise>
											<img class="w80 h80" src="${adminImgPath}/fingerprint/valentine_ico.png"/>
										</c:otherwise>
									</c:choose>
								</div>
					...
					<div class="cont_config">
						...
						<div class="screen">
									...
									<div class="preview">
										<c:choose>
											<c:when test="${list.picUrl != null && !empty(list.picUrl)}">
												<img class="w200 h100" src="${resUrl}/${list.picUrl}" />
											</c:when>
											<c:otherwise>
												<img class="w200 h100" src="${adminImgPath}/fingerprint/gift.gif" />
											</c:otherwise>
										</c:choose>
									</div>
									<div class="upload_file">
							...
							<div class="row">
								...
								<div class="fr">
									<p>
										<input class="verify_num w80 probability" type="text" name="probability" value="${conf.probability}"/>
										<b>100%代表全部获奖</b>
									</p>
								</div>
								<div class="clear"></div>
							...
							<div class="row">
								...
								<div class="fr">
									<p>
										<label><input type="radio" name="1" value="0" <c:if test="${list.exchangeState == '0'}">checked</c:if>/>是</label>&nbsp;&nbsp;
										<label><input type="radio" name="1" value="1" <c:if test="${list.exchangeState == null || list.exchangeState == '1'}">checked</c:if>
											/>否</label>
					...
					<input type="hidden" name="awards" id="awards" value="${conf.awards}"/>
					...
					<div class="custom_config">
						<div class="row">
							...
							<div class="fr w560">
								<p>
									<textarea name="relation" class="verify_relation w430 h120" maxlength="500">${conf.relation}</textarea>
									<b>关系之间以逗号隔开</b>
								</p>
							</div>
							<div class="clear"></div>
						...
						<div class="row">
							...
							<div class="fr w560">
								<p>
									<input name="prizeRelation" class="verify_relation" type="text" value="${conf.prizeRelation}" maxlength="50" />
									<b>中奖时显示的关系</b>
							...
							<div class="fr w560">
								<div class="preview">
									<c:choose>
										...
										<c:otherwise>  
											<img class="w160 h240" src="${adminImgPath}/fingerprint/cover.jpg" />
										</c:otherwise>
									</c:choose>
								</div>
								<div class="upload_file">
							...
							<div class="fr w560">
								<div class="preview">
									<c:choose>
										...
										<c:otherwise>  
											<img class="w160 h240" src="${adminImgPath}/fingerprint/bg.jpg" />
										</c:otherwise>
									</c:choose>
								</div>
								<div class="upload_file">
