...
<body>
	...
	<div class="w1190 receipt">
		...
		<div class="fl w840 main">
			...
			<div class="cont">
				<form action="${path}/pluginadmin/receipt/add_do" method="post" onsubmit="return onClick();">
					...
					<div class="basic_config">
						<div class="row">
							...
							<div class="fr">
								<p>
									<input name="name" class="verify_name w300" type="text" maxlength="30" value="刮FA票" />
								</p>
							</div>
							<div class="clear"></div>
						</div>
						<div class="row">
							...
							<div class="fr">
								<div class="preview"><img class="w80 h80" src="${adminImgPath}/receipt/logo.png" /></div>
						...
						<div class="row">
							...
							<div class="fr">
								<p>
									<input name="shareTitle" class="verify_title w300" type="text" maxlength="200" value="领电子FA票，刮超级大奖！" />
									<b>发送给朋友、分享朋友圈，均会显示标题</b>
								</p>
								<div class="space_10"><!-- 填充10像素间距 --></div>
								<p>
									<textarea name="shareDescription" class="verify_intro w300" maxlength="36" placeholder="简介">电子FA票，中奖概率超普通发票万倍。还等什么？</textarea>
					...
					<div class="cont_config">
						...
						<div class="screen" data-id="3">
							...
							<div class="row">
								...
								<div class="fr">
									<p>
										<input class="verify_num w80 probability" type="text" value="30" />
										<b>0~100，用户获得该奖品的概率，独立设置，与其他奖品不相关</b>
									</p>
								</div>
								<div class="clear"></div>
					...
					<div class="act_config">
						<div class="row">
							...
							<div class="fr w560">
								<p>
									<input name="sellerName" class="verify_seller w300" type="text" maxlength="30" value="演示商家名">
								</p>
							</div>
							<div class="clear"></div>
						</div>
						...
						<div id="get_password" class="row" style="margin-bottom:10px;">
							...
							<div class="fr w510">
								<p>
									<label><input type="radio" name="bInputPass" value="0"/>是</label>&nbsp;&nbsp;
									<label><input class="cant_join" type="radio" name="bInputPass" checked="checked" value="1"/>否</label>
								</p>
							</div>
							<div class="clear"></div>
						</div>
						<div id="admin_password" class="row" style="display:none;">
							<strong class="fl w270">管理员密码：</strong>
							<div class="fr w510">
								<p>
									<input id="password" name="password" class=" w300" type="text" maxlength="30" />
								</p>
							</div>
							<div class="clear"></div>
						</div>
						<div id="play_time" class="row">
							...
							<div class="fr w510">
								<p>
									<input name="playTimes" class="act_count verify_num w80" type="text" value="3" />
