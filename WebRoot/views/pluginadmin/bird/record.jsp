...
<link type="text/css" rel="stylesheet" href="${adminCssPath}/bird.css"/>
...
<script type="text/javascript" src="${adminJsPath}/bird.js"></script>
...
<body>
	...
	<div class="w1190 bird">
		...
		<div class="fl w840 main">
			<div class="tab_title">
				<c:choose>
					<c:when test="${userPluginId != null && userPluginId != 0}">
						<a href="${path}/pluginadmin/bird/add/${userPluginId}">活动设置</a>
					</c:when>
					<c:otherwise>
						<a href="${path}/pluginadmin/bird/edit/${activityId}">活动设置</a>
					</c:otherwise>
				</c:choose>
			...
			<div class="cont mark">
				<h4 class="tr">
				<button id="copyid" class="btn_copy" value="${basePath}/cj/bird/myprize/${activityId}" onclick="init('copyid')">双击复制兑换领奖手机页面地址</button>
					<script type="text/javascript">
					 function exportRecord(){
						 ...
						 window.location.href="${path}/pluginadmin/bird/exportRecord/${activityId}?start="+start+"&end="+end;
					 }
					</script>
					<i>请输入导出条数：从</i>
