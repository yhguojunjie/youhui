...
<body>
	...
	<div class="w1190 bird">
		...
		<div class="fl w840 main">
			...
			<div class="cont">
				<form action="${path}/pluginadmin/bird/add_do" method="post" onsubmit="return onClick();">
					...
					<div class="basic_config">
						<div class="row">
							...
							<div class="fr">
								<p>
									<input name="name" class="verify_name w300" type="text" maxlength="30" value="小鸟闯关" />
								</p>
							</div>
							<div class="clear"></div>
						</div>
						<div class="row">
							...
							<div class="fr">
								<div class="preview"><img class="w80 h80" src="${adminImgPath}/bird/logo.png" /></div>
						...
						<div class="row">
							...
							<div class="fr">
								<p>
									<input name="shareTitle" class="verify_title w300" type="text" maxlength="200" value="飞过去，奖品就是你的！快来挑战吧~" />
									<b>发送给朋友、分享朋友圈，均会显示标题</b>
								</p>
								<div class="space_10"><!-- 填充10像素间距 --></div>
								<p>
									<textarea name="shareDescription" class="verify_intro w300" maxlength="36" placeholder="简介">我发现一个好玩还能赢奖品的游戏，推荐给你！</textarea>
					...
					<div class="cont_config">
						...
						<div class="screen" data-id="1">
							<h4 class="screen_title"><strong>奖项1</strong></h4>
							<div class="row">
								<strong class="fl">奖品名称：</strong>
								<div class="fr">
									<p>
										<input class="verify_prizename w300" type="text" maxlength="50" value="小黄鸡公仔" />
									</p>
								</div>
								<div class="clear"></div>
							</div>
							<div class="row">
								...
								<div class="fr">
									<p>
										<input class="verify_num w80" type="text" value="10000" />
										<b>奖品发完后，不会再有用户得奖</b>
									</p>
								</div>
								<div class="clear"></div>
							...
							<div class="row">
								...
								<div class="fr">
									<div class="preview"><img class="w80 h80" src="${adminImgPath}/bird/1.png" /></div>
									<div class="upload_file">
						...
						<div class="screen" data-id="2">
							<h4 class="screen_title"><strong>奖项2</strong></h4>
							<div class="row">
								<strong class="fl">奖品名称：</strong>
								<div class="fr">
									<p>
										<input class="verify_prizename w300" type="text" maxlength="50" value="牛皮卡包" />
									</p>
								</div>
								<div class="clear"></div>
							</div>
							...
							<div class="row">
								...
								<div class="fr">
									<p>
										<input class="verify_num w80" type="text" value="20" />
										<b>奖品出现的关数</b>
									</p>
								</div>
								<div class="clear"></div>
							...
							<div class="row">
								<strong class="fl space_15">奖品图片：</strong>
								<div class="fr">
									<div class="preview"><img class="w80 h80" src="${adminImgPath}//bird/2.png" /></div>
									<div class="upload_file">
										<input type="text" class="fileuploadclass"/>
										<span><em class="ico_image"></em>选择图片</span>
									</div>
						...
						<div class="screen" data-id="3">
							<h4 class="screen_title"><strong>奖项3</strong></h4>
							<div class="row">
								<strong class="fl">奖品名称：</strong>
								<div class="fr">
									<p>
										<input class="verify_prizename w300" type="text" maxlength="50" value="木质餐具" />
									</p>
								</div>
								<div class="clear"></div>
							</div>
							...
							<div class="row">
								...
								<div class="fr">
									<p>
										<input class="verify_num w80" type="text" value="40" />
										<b>奖品出现的关数</b>
									</p>
								</div>
								<div class="clear"></div>
							...
							<div class="row">
								<strong class="fl space_15">奖品图片：</strong>
								<div class="fr">
									<div class="preview"><img class="w80 h80" src="${adminImgPath}//bird/3.png" /></div>
									<div class="upload_file">
										<input type="text" class="fileuploadclass"/>
										<span><em class="ico_image"></em>选择图片</span>
									</div>
						...
						<div class="screen" data-id="4">
							<h4 class="screen_title"><strong>奖项4</strong></h4>
							<div class="row">
								<strong class="fl">奖品名称：</strong>
								<div class="fr">
									<p>
										<input class="verify_prizename w300" type="text" maxlength="50" value="简约钱包" />
									</p>
								</div>
								<div class="clear"></div>
							</div>
							...
							<div class="row">
								...
								<div class="fr">
									<p>
										<input class="verify_num w80" type="text" value="60" />
										<b>奖品出现的关数</b>
									</p>
								</div>
								<div class="clear"></div>
							...
							<div class="row">
								<strong class="fl space_15">奖品图片：</strong>
								<div class="fr">
									<div class="preview"><img class="w80 h80" src="${adminImgPath}//bird/4.png" /></div>
									<div class="upload_file">
										<input type="text" class="fileuploadclass"/>
										<span><em class="ico_image"></em>选择图片</span>
									</div>
							...
							<div class="row">
								...
								<div class="fr w560">
									<p>
										<label><input class="act_ticket" type="radio" name="4" value="0"/>是</label>&nbsp;&nbsp;
										<label><input type="radio" checked="checked" name="4" value="1" />否</label>
										<b>获奖用户需到店，出示中奖记录，更改兑奖状态，才完成兑奖</b>
									</p>
								</div>
								<div class="clear"></div>
						...
						<!-- 四等奖 结束 -->
						<!-- 五等奖 开始 -->
						<div class="screen" data-id="5">
							<h4 class="screen_title"><strong>奖项5</strong></h4>
							<div class="row">
								<strong class="fl">奖品名称：</strong>
								<div class="fr">
									<p>
										<input class="verify_prizename w300" type="text" maxlength="50" value="柠檬水杯" />
									</p>
								</div>
								<div class="clear"></div>
							</div>
							...
							<div class="row">
								...
								<div class="fr">
									<p>
										<input class="verify_num w80" type="text" value="80" />
										<b>奖品出现的关数</b>
									</p>
								</div>
								<div class="clear"></div>
							...
							<div class="row">
								<strong class="fl space_15">奖品图片：</strong>
								<div class="fr">
									<div class="preview"><img class="w80 h80" src="${adminImgPath}//bird/5.png" /></div>
									<div class="upload_file">
										<input type="text" class="fileuploadclass"/>
										<span><em class="ico_image"></em>选择图片</span>
									</div>
							...
							<div class="row">
								...
								<div class="fr w560">
									<p>
										<label><input class="act_ticket" type="radio" name="5" value="0"/>是</label>&nbsp;&nbsp;
										<label><input type="radio" checked="checked" name="5" value="1" />否</label>
										<b>获奖用户需到店，出示中奖记录，更改兑奖状态，才完成兑奖</b>
									</p>
								</div>
								<div class="clear"></div>
						...
						<div class="row">
							...
							<div class="fr w560">
								<p class="actrule_msgbox">
									<textarea name="rule" class="verify_rule w430 h120">
									· 活动时间： 至 。
· 每人每天最多游戏3次。
· 分享朋友圈或发送给好友可获得额外游戏机会。
· 碰到奖品算获得，同一种奖品只能获得一次，数量有限，先到先得。
（模版演示，纯属体验，不予兑奖！)
									</textarea>
								</p>
							</div>
						...
						<div class="row">
							...
							<div class="fr w560">
								<p>
									<input name="exExplain" class="verify_contact w420" type="text" value="请填写以下资料：(模版演示，纯属体验，不予兑奖！)" maxlength="50" />
									<b>用户兑奖时显示</b>
								</p>
							</div>
							<div class="clear"></div>
			...
			if($(this).val() == 0){
				$('#followDiv').html('<div class="space_10"></div>\
					<strong class="fl w220">引导关注链接：</strong>\
						<div class="fr w560">\
							<p>\
								<input name="followUrl" class="verify_contact1 w420" type="text" value="http://mp.weixin.qq.com/s?__biz=MzA4MzA1MjY2MQ==&mid=225062650&idx=1&sn=0cf611e1671b331b4570eaa5b0084a2c#rd" /><br />\
								<b>参与用户要查看领奖页，会先跳转该链接。建议用公众号新增图文素材，内容为活动规则，重点引导用户关注，再在公众号内设置关键词回复，如用户发送“小鸟”，公众号将回复排行榜页链接地址（在PC端活动配置排行榜栏目获取)。</b>\
							</p>\
						</div>\
						<div class="clear"></div>');
