	...
	<div class="w1190 runman">
		...
		<div class="fl w840 main">
			<div class="tab_title">
				...
				<a href="${path}/pluginadmin/runman/record/${conf.activityId}">中奖名单</a>
				<a href="${path}/pluginadmin/runman/rank/${conf.activityId}">排行榜</a>
			</div>
			<div class="cont">
				<form action="${path}/pluginadmin/runman/edit_do" method="post" onsubmit="return onClick();">
						...
						<div class="row">
							...
							<div class="fr">
								<div class="preview">
									...
									<c:otherwise>
										<img class="w80 h80" src="${adminImgPath}/runman_ico.png" />
									</c:otherwise>
									</c:choose>
								</div>
