...
<link type="text/css" rel="stylesheet" href="${adminCssPath}/runman.css?v=2"/>
...
<script type="text/javascript" src="${adminJsPath}/runman.js?v=2"></script>
...
<body>
	...
	<div class="w1190 runman">
		...
		<div class="fl w840 main">
			...
			<div class="cont">
				<form action="${path}/pluginadmin/runman/add_do" method="post" onsubmit="return onClick();">
					...
					<div class="basic_config">
						<div class="row">
							...
							<div class="fr">
								<p>
									<input name="title" class="verify_name w300" type="text" maxlength="30" value="奔跑吧英雄" />
								</p>
							</div>
							<div class="clear"></div>
						</div>
						<div class="row">
							...
							<div class="fr">
								<div class="preview"><img class="w80 h80" src="${adminImgPath}/runman_ico.png" /></div>
						...
						<div class="row">
							...
							<div class="fr">
								<p>
									<input name="shareTitle" class="verify_title w300" type="text" maxlength="200" value="我在“奔跑吧英雄”中成功跑出n米，来挑战我吧？冲进排行榜还有奖品拿！" />
									<b>n代表玩家分数，如误删可再补充</b>
								</p>
								<div class="space_10"><!-- 填充10像素间距 --></div>
								<p>
									<textarea name="shareDescription" class="verify_intro w300" maxlength="36" placeholder="简介">邓感超人，Baby，宝宝邀你一起热力开跑啦！快来挑战一下。</textarea>
					...
					<div class="cont_config">
						...
						<div class="screen" data-id="1">
							...
							<div class="row">
								...
								<div class="fr">
									<div class="preview"><img class="w80 h80" src="${adminImgPath}/runman_img1.png" /></div>
									<div class="upload_file">
					...
					<div class="act_config">
							...
							<div class="space_10"></div>
								...
								<div class="fr w560">
									<p>
										...
										<b>参与用户要查看排行榜页(自己的名次、领奖)，会先跳转该链接。建议用公众号新增图文素材，内容为活动规则，重点引导用户关注，再在公众号内设置关键词回复，如用户发送“奔跑”，公众号将回复排行榜页链接地址（在PC端活动配置排行榜栏目获取)。
										</b>
									</p>
								</div>
							<div class="clear"></div>
						...
						<div class="row">
							...
							<div class="fr w560">
								<p>
									<input name="playTimes" class="verify_num w80 game_count" type="text" value="2" />
...
<script type="text/javascript">
	...
	function verify_submit(){
		...
		if(verify > 0){
			$('.runman .main .cont .cont_config,.runman .main .cont .act_config').attr("style","display:block;");
			$('.runman .main .cont h3 span').text("收起");
			alert("请核查全部字段是否正确填写");
			return false;
		}else{
			return true;
				...
				$('#followDiv').html('<div class="space_10"></div>\
					<strong class="fl w220">引导关注链接：</strong>\
						<div class="fr w560">\
							<p>\
								<input name="followUrl" class="verify_contact1 w420" type="text" value="" /><br />\
								<b>参与用户要查看排行榜页(自己的名次、领奖)，会先跳转该链接。建议用公众号新增图文素材，内容为活动规则，重点引导用户关注，再在公众号内设置关键词回复，如用户发送“奔跑”，公众号将回复排行榜页链接地址（在PC端活动配置排行榜栏目获取)。</b>\
							</p>\
						</div>\
						<div class="clear"></div>');
			}else{
