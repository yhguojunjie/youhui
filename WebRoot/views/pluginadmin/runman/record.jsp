...
<link type="text/css" rel="stylesheet" href="${adminCssPath}/runman.css"/>
	...
	<div class="w1190 runman">
		...
		<div class="fl w840 main">
			<div class="tab_title">
				...
				<a href="${path}/pluginadmin/runman/rank/${activityId}">排行榜</a>
			</div>
			<div class="cont mark">
				<h4 class="tr">
					<script type="text/javascript">
					 function exportRecord(){
						 ...
						 window.location.href="${path}/pluginadmin/runman/exportRecord/${activityId}?start="+start+"&end="+end;
					 }
					</script>
					<i>请输入导出条数：从</i>
