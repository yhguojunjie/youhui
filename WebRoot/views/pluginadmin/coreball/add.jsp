...
<link type="text/css" rel="stylesheet" href="${adminCssPath}/coreball.css" />
...
<body>
	...
	<div class="w1190 coreball">
		...
		<div class="fl w840 main">
			...
			<div class="cont">
				<form action="${path}/pluginadmin/coreball/add_do" method="post" onsubmit="return onClick();">
					...
					<div class="basic_config">
						<div class="row">
							...
							<div class="fr">
								<p>
									<input class="verify_name w300" type="text" maxlength="30" name="name" value="魔球" />
								</p>
							</div>
							<div class="clear"></div>
						</div>
						<div class="row">
							...
							<div class="fr">
								<div class="preview"><img class="w80 h80" src="${adminImgPath}/coreball/logo.png" /></div>
						...
						<div class="row">
							...
							<div class="fr">
								<p>
									<input class="verify_title w300" type="text" maxlength="25" placeholder="标题" value="我已经插到n关，谁敢来战？" name="shareTitle"/>
									<b>发送给朋友、分享朋友圈，均会显示标题（n代表已通关数）</b>
								</p>
								<div class="space_10"><!-- 填充10像素间距 --></div>
								<p>
									<textarea class="verify_intro w300" maxlength="36" placeholder="简介" name="shareDescription">强迫症患者福音，看谁插得又快又准。</textarea>
							...
							<div class="space_10"></div>
								...
								<div class="fr">
									<p>
										...
										<b>用户打开好友发送或分享至朋友圈的链接，欲玩高级关卡（第三关以后）会先跳转该链接。建议用公众号新增图文素材，内容为活动规则，重点引导用户关注，再在公众号内设置关键词回复，如用户发送“魔球”，公众号将回复活动链接地址（在PC端我的活动列表获取，该状态下仅在被分享出去的页面生效，原活动链接地址打开的页面不生效)。</b>
									</p>
								</div>
							<div class="clear"></div>
						</div>
