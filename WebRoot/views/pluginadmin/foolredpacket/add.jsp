...
<body>
	...
	<div class="w1190 foolredpacket">
		...
		<div class="fl w840 main">
			...
			<div class="cont">
				<form action="${path}/pluginadmin/foolredpacket/add_do" method="post" onsubmit="return onClick();">
					...
					<div class="basic_config">
						<div class="row">
							...
							<div class="fr">
								<p>
									<input class="verify_name w300" type="text" maxlength="30" name="name" value="礼包" />
								</p>
							</div>
							<div class="clear"></div>
						</div>
						<div class="row">
							...
							<div class="fr">
								<div class="preview"><img class="w80 h80" src="${adminImgPath}/foolredpacket/ico.png" /></div>
						...
						<div class="row">
							...
							<div class="fr">
								<p>
									<input class="verify_title w300" type="text" maxlength="25" placeholder="标题" value="给你发了一个礼包" name="shareTitle"/>
									<b>发送给朋友、分享朋友圈，均会显示标题</b>
								</p>
								<div class="space_10"><!-- 填充10像素间距 --></div>
								<p>
									<textarea class="verify_intro w300" maxlength="36" placeholder="简介" name="shareDescription">查看礼包</textarea>
