...
<link type="text/css" rel="stylesheet" href="${adminCssPath}/foolredpacket.css" />
...
<body>
	...
	<div class="w1190 foolredpacket">
		...
		<div class="fl w840 main">
			...
			<div class="cont">
				<form action="${path}/pluginadmin/foolredpacket/edit_do" method="post" onsubmit="return onClick();">
						...
						<div class="row">
							...
							<div class="fr">
								...
								<c:choose>
									...
									<c:otherwise>
										<img class="w80 h80" src="${adminImgPath}/foolredpacket/ico.png"/>
									</c:otherwise>
								</c:choose>
								</div>
								...
								<div class="space_10"></div>
									...
									<div class="fr">
										<p>
											...
											<b>用户打开好友发送或分享至朋友圈的链接，欲参与活动会先跳转该链接。建议用公众号新增图文素材，内容为活动规则，重点引导用户关注，再在公众号内设置关键词回复，如用户发送“愚人”，公众号将回复活动链接地址（在PC端我的活动列表获取，该状态下仅在被分享出去的页面生效，原活动链接地址打开的页面不生效)。</b>
										</p>
									</div>
								<div class="clear"></div>
							</div>
