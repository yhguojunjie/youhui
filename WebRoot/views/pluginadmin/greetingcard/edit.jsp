...
<body>
	...
	<div class="w1190 greetingcard">
		...
		<div class="fl w840 main">
			...
			<div class="cont">
				<form action="${path}/pluginadmin/greetingcard/edit_do" method="post" onsubmit="return onClick();">
					...
					<div class="basic_config">
						<div class="row">
							...
							<div class="fr">
								<p>
									<input class="w300 verify_name" type="text" name="name" maxlength="30" value="${conf.name}" />
								</p>
							</div>
							<div class="clear"></div>
						</div>
						<div class="row">
							...
							<div class="fr">
								<div class="preview">
									...
									<c:otherwise>
										<img class="w80 h80" src="${adminImgPath}/greetingcard/shareImg.jpg" />
									</c:otherwise>
									</c:choose>
								</div>
						...
						<div class="row">
							...
							<div class="fr">
								<div class="preview logoview">
									<c:choose>
									<c:when test="${conf.logoUrl != null && !empty(conf.logoUrl)}">
										<img class="w80 h80" src="${resUrl}/${conf.logoUrl}" />
									</c:when>
									<c:otherwise>
										<img class="w80 h80" src="${adminImgPath}/greetingcard/greetcard_plugin.jpg" />
									</c:otherwise>
									</c:choose>
								</div>
								<div class="upload_file">
						...
						<div class="row">
							...
							<div class="fr">
								<p>
									<input class="w420" type="text" name="shareLink" value="${conf.shareLink}"/>
									<b>不填写则不跳转</b>
								</p>
							</div>
							<div class="clear"></div>
