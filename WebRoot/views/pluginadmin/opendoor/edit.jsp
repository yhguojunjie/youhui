	...
	<div class="w1190 bigwheel">
		...
		<div class="fl w840 main">
			<div class="tab_title">
				...
				<a href="${path}/pluginadmin/opendoor/record/${conf.activityId}">中奖名单</a>
			</div>
			<div class="cont">
				<form action="${path}/pluginadmin/opendoor/edit_do" method="post" onsubmit="return onClick();">
					...
					<div class="basic_config">
						<div class="row">
							...
							<div class="fr">
								<p>
									<input name="name" value="${conf.name}" class="verify_name w300" type="text" maxlength="30"/>
								</p>
							</div>
							<div class="clear"></div>
						</div>
						<div class="row">
							...
							<div class="fr">
								<div class="preview">
									...
									<c:otherwise>
										<img class="w80 h80 imghead" src="${adminImgPath}/opendoor/logo.png" />
									</c:otherwise>
									</c:choose>
								</div>
					...
					<div class="act_config">
						...
						<div class="row">
							...
							<div class="fr w510">
								<p>
									<input name="playTimes" value="${conf.playTimes}" class="act_count verify_num w80" type="text" >
						...
						<div class="row">
							...
							<div class="fr w560">
								<p>
									<input name="exExplain" class="verify_contact w420" type="text" placeholder="请填写以下资料：(模版演示，纯属体验，不予兑奖！)" maxlength="200" value="${conf.exExplain}"/>
									<b>用户兑奖时显示</b>
								</p>
							</div>
							<div class="clear"></div>
							...
							<div class="fr w560">
								<div class="preview">
									<c:choose>
										...
										<c:otherwise>  
											<img class="w160 h240" src="${adminImgPath}/opendoor/cover.jpg" />
										</c:otherwise>
									</c:choose>
								</div>
								<div class="upload_file">
