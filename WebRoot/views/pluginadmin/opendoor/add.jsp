	...
	<div class="w1190 bigwheel">
		...
		<div class="fl w840 main">
			<div class="tab_title">
				...
				<a href="${path}/pluginadmin/opendoor/record/0?upid=${userPluginId}">中奖名单</a>
			</div>
			<div class="cont">
				<form action="${path}/pluginadmin/opendoor/add_do" method="post" onsubmit="return onClick();">
					...
					<div class="basic_config">
						<div class="row">
							...
							<div class="fr">
								<p>
									<input name="name" class="verify_name w300" type="text" maxlength="30" value="芝麻开门" />
								</p>
							</div>
							<div class="clear"></div>
						</div>
						<div class="row">
							...
							<div class="fr">
								<div class="preview"><img class="w80 h80 imghead" src="${adminImgPath}/opendoor/logo.png" /></div>
						...
						<div class="row">
							...
							<div class="fr">
								...
								<div class="ad_upcont space_10">
									<div class="preview"><img class="w320 h50 imghead" src="${adminImgPath}/ad.gif" /></div>
									<div class="upload_file">
						...
						<div class="row">
							...
							<div class="fr">
								<p>
									<input name="shareTitle" class="verify_title w300" type="text" maxlength="25" placeholder="标题" value="开门有礼，还等什么？" />
									<b>发送给朋友、分享朋友圈，均会显示标题</b>
								</p>
								<div class="space_10"><!-- 填充10像素间距 --></div>
								<p>
									<textarea name="shareDescription" class="verify_intro w300" maxlength="36" placeholder="简介">好礼就在门后，赶快打开看一看吧！</textarea>
					...
					<div class="cont_config">
						...
						<div class="screen" data-id="1">
							...
							<div class="row">
								...
								<div class="fr">
									<p>
										<input class="verify_prizename w300" type="text" maxlength="50" value="CK香水" />
									</p>
								</div>
								<div class="clear"></div>
							</div>
...
(模版演示，纯属体验，不予兑奖！)</textarea>
						...
						<div class="row">
							...
							<div class="fr w560">
								<p>
									...
									<label class="need_usermsg"><input value="name," checked="checked" disabled="disabled" type="checkbox"/>姓名</label>
					...
					<div class="custom_config">
						<div class="row">
							...
							<div class="fr w560">
								<div class="preview"><img class="w160 h240" src="${adminImgPath}/opendoor/cover.jpg" /></div>
								<div class="upload_file">
