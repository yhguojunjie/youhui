...
<body>
	...
	<div class="w1190 poker">
		...
		<div class="fl w840 main">
			<div class="tab_title">
				<c:choose>
					...
					<c:otherwise>
						...
						<a href="${path}/pluginadmin/poker/join/${activityId}">参与用户</a>
					</c:otherwise>
				</c:choose>
			...
			<div class="cont mark">
				<h4 class="tr">
					<button id="copyid" class="btn_copy" value="${rankUrl}" onclick="init('copyid')">双击复制领奖手机页面地址</button>
						<script type="text/javascript">
						 function exportRecord(){
							 ...
							 window.location.href="${path}/pluginadmin/poker/exportRecord/${activityId}?start="+start+"&end="+end;
						 }
						</script>
					<i>请输入导出条数：从</i>
