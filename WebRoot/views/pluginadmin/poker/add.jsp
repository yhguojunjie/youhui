	...
	<div class="w1190 poker">
		...
		<div class="fl w840 main">
			<div class="tab_title">
				...
				<a href="${path}/pluginadmin/poker/join/0?upid=${userPluginId}">参与用户</a>
				<a href="${path}/pluginadmin/poker/record/0?upid=${userPluginId}">中奖名单</a>
			</div>
			<div class="cont">
				<form action="${path}/pluginadmin/poker/add_do" method="post" onsubmit="return onClick();">
					...
					<div class="basic_config">
						<div class="row">
							...
							<div class="fr">
								<p>
									<input name="name" class="verify_name w300" type="text" maxlength="30" value="我坐庄" />
								</p>
							</div>
							<div class="clear"></div>
						</div>
						<div class="row">
							...
							<div class="fr">
								<div class="preview"><img class="w80 h80" src="${adminImgPath}/poker/poker_ico.png" /></div>
						...
						<div class="row">
							...
							<div class="fr">
								<p>
									<input name="shareTitle" class="verify_title w300" type="text" maxlength="25" placeholder="标题" value="今天我坐庄，“扎金花”邀请你来比大小！" />
									<b>发送给朋友、分享朋友圈，均会显示标题</b>
								</p>
								<div class="space_10"><!-- 填充10像素间距 --></div>
								<p>
									<textarea name="shareDescription" class="verify_intro w300" maxlength="36" placeholder="简介">就差你，我就连胜啦~ 就是这么有自信</textarea>
					...
					<div class="cont_config">
						...
						<div class="screen">
							...
							<div class="row">
								...
								<div class="fr">
									<div class="preview"><img class="w80 h80" src="${adminImgPath}/toothbrush.gif" /></div>
									<div class="upload_file">
							...
							<div class="row">
								...
								<div class="fr">
									<p>
										<label><input type="radio" name="change_gift" value="0"/>是</label>&nbsp;&nbsp;
										<label><input type="radio" checked="checked" name="change_gift" value="1"/>否</label>
					...
					<div class="act_config">
						...
						<div class="row">
							...
							<div class="fr w560">
								<p>
									<input name="playTimes" class="verify_num w80 suc_count" type="text" value="5" />
									<b>大于0</b>
								</p>
							</div>
							<div class="clear"></div>
						...
						<div class="row">
							...
							<div class="fr w560">
								<p class="actrule_msgbox">
									<textarea name="rule" class="verify_rule w430 h120">• 活动时间：2015/01/27 00 至 2015/01/27 23:59:59。
• 每盘连胜局获奖。
• 每个好友每天都可跟庄家比一次牌。
(模版演示，纯属体验，不予兑奖！)</textarea>
						...
						<div class="row">
							...
							<div class="fr w560">
								<p>
									<input name="exExplain" class="verify_contact w420" type="text" value="请填写以下信息：(模版演示，纯属体验，不予兑奖！)" maxlength="50" />
									<b>用户兑奖时显示</b>
								</p>
							</div>
							<div class="clear"></div>
					...
					<div class="custom_config">
						<div class="row">
							...
							<div class="fr w560">
								<div class="preview"><img class="w160 h240" src="${adminImgPath}/poker/cover.jpg" /></div>
								<div class="upload_file">
						...
						<div class="row">
							...
							<div class="fr w560">
								<div class="preview"><img class="w160 h240" src="${adminImgPath}/poker/bg.jpg" /></div>
								<div class="upload_file">
