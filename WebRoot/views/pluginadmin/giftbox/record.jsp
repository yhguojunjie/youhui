	...
	<div class="w1190 giftbox">
		...
		<div class="fl w840 main">
			<div class="tab_title">
				...
				<a href="${path}/pluginadmin/giftbox/join/${activityId}">参与用户</a>
				...
				<h4 class="tr">
						<script type="text/javascript">
						 function exportRecord(){
							 ...
							 window.location.href="${path}/pluginadmin/giftbox/exportRecord/${activityId}?start="+start+"&end="+end;
						 }
						</script>
					<i>请输入导出条数：从</i>
