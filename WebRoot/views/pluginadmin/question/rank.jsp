	...
	<div class="w1190 question">
		...
		<div class="fl w840 main">
			<div class="tab_title">
				...
				<a href="${path}/pluginadmin/question/bank/${activityId}?upid=${userPluginId}">题库管理</a>
				...
				<h4 class="tr">
					...
					<script type="text/javascript">
					 function exportRank(){
						 ...
						 window.location.href="${path}/pluginadmin/question/exportRank/${activityId}?start="+start+"&end="+end;
					 }
					</script>
					<i>请输入导出条数：从</i>
				...
				<table class="rank">
					...
					<c:forEach var="list" items="${recordVos.pageResult}" varStatus="s">
						<tr>
							...
							<td>${list.playTime}秒 ${list.rightNum}分</td>
