		...
		if($(this).prev().find('h4 strong').text().substring(0,1)*1 < 6 ){
			$(this).before('<div class="screen" data-id="'+($(this).prev().find('h4 strong').text().substring(0,1)*1 + 1) +'">\
								...
								<div class="row">\
									...
									<div class="fr">\
										<p>\
											<input class="verify_prizename w300" type="text" maxlength="50" >\
										</p>\
									</div>\
									<div class="clear"></div>\
								</div>\
								<div class="row">\
									...
									<div class="fr">\
										<p>\
											<input class="verify_num w80" type="text" >\
											<b>仅用于活动界面中展示给用户看</b>\
										</p>\
									</div>\
									<div class="clear"></div>\
								...
								<div class="row">\
									...
									<div class="fr">\
										<div class="preview"><img class="w80 h80 imghead" src="'+commonImgPath+'/giftbox.png" /></div>\
...
function popupPrompt(obj,notice){
	...
	$('.prompt_box .close,.prompt_box .btn_cancel,.prompt_box .btn_done').click(function(){
		...
		$.ajax({
			  type: "POST",
			  url : path+"/pluginadmin/tree/changeOpStatus",
...
$(document).ready(function(){
	$('.actrule_msgbox textarea'). focus(function(){
		...
		var ticket = false;
		$('.act_ticket').each(function(){
			if($(this).prop("checked") == true){ticket=true;}
		});
		if(ticket){
			actrule_msgbox += '• 部分奖品需凭“中奖记录”到店兑换。\n';
		}
		actrule_msgbox += '• 请中奖用户关注公众号，回复手机号兑奖。\n(模版演示，纯属体验，不予兑奖！)\n'
...
$(document).ready(function(){
	$(document).on("click",".bigwheel .mark h4.tr .bg_green",function(){
		$.ajax({
			  type: "POST",
			  url : path+"/pluginadmin/tree/getPrizeJson",
...
function popupFalsemark(dataarr){
	...
	$('.add_falsemark .close,.add_falsemark .btn_cancel,.add_falsemark .btn_done').click(function(){
		...
		$.ajax({
			  type: "POST",
			  url : path+"/pluginadmin/tree/addRecord",
			  data:jsondata,
			  dataType: "json",
			  success: function(data){
			  	if(data != 0){
